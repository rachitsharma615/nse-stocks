...
import SectorButton from "./StockList/SectorButton";
import ProgressBar from "./StockList/ProgressBar";
  ...
  render() {
    return (
      <div className="skills">
        ...
        <div className="title">
          <h3>ALL NSE STOCKS AND TOP FIVE TRENDING</h3>
          <p>
            Choose any section to see top 5 stocks of the particular sector.
          </p>
        </div>
